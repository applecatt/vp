<?php
  ...
  if($dayselapsed > 0 and $dayselapsed < $semesterduration){
...
<body>
  ...
  <p><?php if($dayselapseddays){print ("Semestri algusest on möödunud ", $dayselapseddays, " päeva.\nLäbitud on ", $dayselapsedpercentage, "% semestrist.");}?>
  <p><?php if($dayselapsed < 0){print("Semester pole veel alanud!");}?>
  <p><?php if($dayselapsed > $semesterduration){print("Semester on juba läbi");}
</body>
</html>